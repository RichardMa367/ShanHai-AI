...
def validate_config():
    ...
    if settings.jwt_secret_key == "change-this-in-env":
        warnings.append("JWT_SECRET_KEY仍为默认值,请在生产环境中修改")
...
def print_config():
    ...
    print(f"JWT: {'已配置' if settings.jwt_secret_key != 'change-this-in-env' else '默认值(需修改)'}")
